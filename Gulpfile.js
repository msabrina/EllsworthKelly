...
// JS Vendor related.
var jsVendorSRC             = './js/*.js'; // Path to JS vendor folder.
var jsVendorDestination     = './js/*.js'; // Path to place the compiled JS vendors file.
var jsVendorFile            = 'js'; // Compiled JS vendors file name.
// Default set to vendors i.e. vendors.js.

// JS Custom related.
var jsCustomSRC             = './js/*.js'; // Path to JS custom scripts folder.
var jsCustomDestination     = './js/js/'; // Path to place the compiled JS custom scripts file.
var jsCustomFile            = 'js'; // Compiled JS custom file name.
// Default set to custom i.e. custom.js.

// Images related.
var imagesSRC               = '../uploads/2017/**/*.{png,jpg,gif,svg}'; // Source folder of images which should be optimized.
var imagesDestination       = './scss/assets/'; // Destination folder of optimized images. Must be different from the imagesSRC folder.
